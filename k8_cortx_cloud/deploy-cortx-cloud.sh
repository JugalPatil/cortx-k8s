...
function deployCortxConfigMap()
{
    ...
    for i in "${!node_name_list[@]}"; do
        ...
        cortx_data_version=$(extractBlock 'solution.images.cortx_data')
        #cortx_data_version${cortx_data_version/ghcr.io\/seagate\/cortx-all\:/}
        splitDockerImage "${cortx_data_version}"
